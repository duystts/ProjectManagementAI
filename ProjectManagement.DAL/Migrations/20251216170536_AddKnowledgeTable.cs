...
{
    /// <inheritdoc />
    public partial class AddKnowledgeTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Knowledge_ProjectTasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Knowledge_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Knowledge_ProjectId",
                table: "Knowledge",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Knowledge_TaskId",
                table: "Knowledge",
                column: "TaskId");
